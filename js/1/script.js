...
function calcScore(name1, ca1, ca2, ca3, exam) {
  ...
  if (totalScore < 50) {
    console.log(
      `The total score out of 100 is ${totalScore}, ${name1} You have failed this course`
    );
  } else if (totalScore >= 50 && totalScore < 95) {
    console.log(
      `The total score out of 100 is ${totalScore}, Good Job ${name1}`
    );
  } else {
    console.log(
      `The total score out of 100 is ${totalScore}, Excellent job ${name1}`
    );
  }
}
